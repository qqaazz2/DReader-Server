package com.example.DReaderServer.service.impl.book;
...
//import com.example.DReaderServer.mapper.book.SeriesMapper;
...
@Service
@Transactional
public class SeriesServiceImpl extends ServiceImpl<FilesDetailsMapper, FilesDetails> implements SeriesService {
//    @Resource
